...
print('TESTTTTTTTTTTTT:',driver.find_element_by_xpath("//ol[@class='breadcrumb']/li[@class='breadcrumb-item']/a").text)
...
df.to_csv('property_details_2-bhk.csv', index=False, encoding='utf-8')
